...
class SchemaPluginApi(GradingSystemPluginInterface):
    id = 'devilry_gradingsystemplugin_form'
    ...
    def get_edit_feedback_url(self, deliveryid):
        return reverse('devilry_gradingsystemplugin_form_feedbackeditor', kwargs={'deliveryid': deliveryid})

    #def get_bulkedit_feedback_url(self, assignmentid):
    #    return reverse('devilry_gradingsystemplugin_form_feedbackbulkeditor', kwargs={'assignmentid': assignmentid})
